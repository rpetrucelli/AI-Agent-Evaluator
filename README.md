...
It then executes the experiment, calculates the optimal trajectory (which we define as the minumum number of steps taken from an agent run), and then returns the convergence score for each prompt run.  
